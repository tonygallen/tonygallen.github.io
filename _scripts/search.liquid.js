          ...
          {%- unless child.title == 'divider' -%}
            {
              ...
              {%- if child.permalink contains "/posts/" -%}{%- assign url = "/posts/" -%} {%- else -%}{%- assign url = child.permalink -%}{%- endif -%}
      ...
      {%- else -%}
        {
          ...
          {%- if p.permalink contains "/posts/" -%}{%- assign url = "/posts/" -%} {%- else -%}{%- assign url = p.url -%}{%- endif -%}
